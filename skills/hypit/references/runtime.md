...
`hypihub.oauth` credential and defaults to `victor-upmeet/whisperx`. The Skill-created Profile must
bind this capability to HypiHub.
...
than by a remote queue. WhisperX alignment uses the HypiHub lane in the Skill path.
