...
`@narratage/caption-fine` is the first official family. It declares no fields and uses one uniform
static appearance for all Words in a Cue. Another package may define karaoke or field-dependent
