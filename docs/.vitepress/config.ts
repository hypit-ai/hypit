    ...
    "/quickstart": [
      {
        ...
        items: [
          ...
          { text: "Caption, Media, Typography & Audio Tracks", link: "/quickstart/tracks" },
    ...
    "/guide/": [
      {
        ...
        items: [
          ...
          { text: "Runtime & External Services", link: "/guide/services" },
    ...
    "/zh/quickstart": [
      {
        ...
        items: [
          ...
          { text: "字幕、Media、Typography 与 Audio 轨道", link: "/zh/quickstart/tracks" },
    ...
    "/zh/guide/": [
      {
        ...
        items: [
          ...
          { text: "Runtime 与外部服务", link: "/zh/guide/services" },
