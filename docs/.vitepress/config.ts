  ...
  sidebar: {
    ...
    "/guide/": [
      ...
      },
      {
        ...
        collapsed: true,
        items: [
          { text: "Core Kernel", link: "/guide/spec/core-kernel" },
          { text: "Author Surface Binding", link: "/guide/spec/author-surface-binding" },
          { text: "Script Surface", link: "/guide/spec/script-surface" },
          { text: "Shared Spatial Layout", link: "/guide/spec/spatial-layout" },
          { text: "Track Authoring Model", link: "/guide/spec/track-authoring" },
          { text: "Track and Composition", link: "/guide/spec/track-composition" },
          { text: "Visual IR", link: "/guide/spec/visual-ir" },
          { text: "Track Expressiveness Gate", link: "/guide/spec/track-expressiveness" },
          { text: "Caption Program", link: "/guide/spec/caption-program" },
          { text: "Fine Caption Style", link: "/guide/spec/caption-fine" },
          { text: "Media Track", link: "/guide/spec/media-track" },
          { text: "Typography Track", link: "/guide/spec/typography-track" },
          { text: "Audio Track", link: "/guide/spec/audio-track" },
          { text: "Deck Track", link: "/guide/spec/deck-track" },
          { text: "Ranking Track", link: "/guide/spec/ranking-track" },
          { text: "Screen Overlay", link: "/guide/spec/screen-overlay" },
        ],
      },
    ],
  },
  ...
  sidebar: {
    ...
    "/zh/guide/": [
      ...
      },
      {
        ...
        collapsed: true,
        items: [
          { text: "Core Kernel", link: "/zh/guide/spec/core-kernel" },
          { text: "Author Surface 绑定", link: "/zh/guide/spec/author-surface-binding" },
          { text: "Script Surface", link: "/zh/guide/spec/script-surface" },
          { text: "共享空间布局", link: "/zh/guide/spec/spatial-layout" },
          { text: "Track 创作模型", link: "/zh/guide/spec/track-authoring" },
          { text: "Track 与 Composition", link: "/zh/guide/spec/track-composition" },
          { text: "Visual IR", link: "/zh/guide/spec/visual-ir" },
          { text: "Track 表现力门槛", link: "/zh/guide/spec/track-expressiveness" },
          { text: "Caption Program", link: "/zh/guide/spec/caption-program" },
          { text: "Fine Caption 样式族", link: "/zh/guide/spec/caption-fine" },
          { text: "Media Track", link: "/zh/guide/spec/media-track" },
          { text: "Typography Track", link: "/zh/guide/spec/typography-track" },
          { text: "Audio Track", link: "/zh/guide/spec/audio-track" },
          { text: "Deck Track", link: "/zh/guide/spec/deck-track" },
          { text: "Ranking Track", link: "/zh/guide/spec/ranking-track" },
          { text: "Screen Overlay", link: "/zh/guide/spec/screen-overlay" },
        ],
      },
    ],
  },
