...
@hypit/mimo-speech           Xiaomi MiMo 音色设计与音色克隆模型及作者 Surface
...
@hypit/provider-hypihub              HypiHub 生成、Gemini VLM 与 WhisperX 网关
...
@hypit/provider-xiaomi-mimo           Xiaomi 官方 MiMo 音色设计与音色克隆 API
```
