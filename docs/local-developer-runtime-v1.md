...
3. finish the official deterministic Speech Align/Caption component facets; the four SpeechTake
   Product projections are already locked and activated from the official implementation package;
