...
description: Implemented pre-release authority for the official two-dimensional Text package.
---
...
The complete Text model is the orthogonal product of:
...
union and coexist as peer items in one Text Track.
...
`VisualColorPaint` supports solid, linear-gradient and radial-gradient Paint with an ordered list of color
