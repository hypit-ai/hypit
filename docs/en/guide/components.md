...
Components that call video-generation APIs also ship with a Runtime implementation. Authors declare the content; the Runtime handles requests, queues, and downloads. See [Runtime & Providers](/en/guide/runtime).
