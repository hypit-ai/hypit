...
provider-neutral `GeneratedVideoSet` contract from `@svml/generation`.

The package does not call an API. `@svml/provider-kie` is one separately selected Runtime Endpoint
