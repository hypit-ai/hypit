...
export function writeCliHelp(io: CliIo, topic?: string): void {
  ...
  io.write([
    ...
    "  runtime use <profile>                     select this project's execution environment",
    "  plan <run-source>                         see exactly what this Run will demand",
    "  build <run-source>                        submit durable work; add --follow to watch",
    "  get <build-id>                            read or copy an archived result",
    ...
    "  cancel <build-id>          withdraw one Build and reconcile submitted work",
    "",
    ...
    "  packages sync <run>                    derive both project locks",
