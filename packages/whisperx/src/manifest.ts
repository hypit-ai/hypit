...
export const whisperXMarkupSurfaces = [{
    ...
    vocabulary: {
      ...
      attributes: [
        ...
        { name: "language", kind: "literal", required: false,
          ...
          summary: "For a Segment with Tokens, explicitly selects the WhisperX alignment model by language code." },
      ],
      ports: [
  ...
  segment={story.segment.opening} media={opening-media.media} language="en"/>`,
      notes: [
        ...
        "For speech, language is never detected from Script text or audio; each alignment call states its WhisperX language code explicitly.",
