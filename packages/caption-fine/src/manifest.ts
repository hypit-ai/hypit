          ...
          { name: "recipe", kind: "reference", required: true, accepts: [svsRecipeType],
            ...
            recipe: withFineCaptionRecipeGroups([
              ...
              { name: "active-stroke-width", required: false, fallback: "stroke-width",
                summary: "Sets the active glyph outline thickness in pixels. It inherits `stroke-width`, and the same proportion holds: emphasis on the spoken Word is carried by its Paint, so thickening its outline past the rest buys little and closes the gaps between its letters first." },
