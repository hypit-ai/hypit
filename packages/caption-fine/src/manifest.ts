          ...
          { name: "recipe", kind: "reference", required: true, accepts: [svsRecipeType],
            ...
            recipe: [
              ...
              { name: "stroke-width", required: false, fallback: "0",
                summary: "Sets the glyph outline thickness in pixels. An outline that only has to separate the caption from the picture behind it is thin — around a twentieth of `size`, so roughly 2px at a `size` of 46. It grows quickly: past about a tenth of `size` the outline starts closing the counters of a, e and o and the caption reads as a slab rather than as letters." },
              ...
              { name: "glow-blur", required: false, fallback: "0",
                summary: "Spreads the glyph halo by this many pixels. A halo reads as a halo while it stays close to the glyph — near a tenth of `size`. Spread wide it stops tracing the letters, fills the space between them and washes the caption into a bright smear; the counters go first, exactly as they do under a heavy outline." },
              ...
              { name: "active-stroke-width", required: false, fallback: "stroke-width",
                summary: "Sets the active glyph outline thickness in pixels. It inherits `stroke-width`, and the same proportion holds: emphasis on the spoken Word is carried by its Paint, so thickening its outline past the rest buys little and closes its counters first." },
