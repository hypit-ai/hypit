...
Frontend, Text Surface and Type Validator facets. Loading verifies all artifact bytes before
executing any activation entry. Authored Records emitted by activated Surfaces pass the same
Manifest-locked Type admission gate used later for provided, Producer and Provider values.
