    ...
    ...(never.length === 0 ? {} : {
      never_compared: {
        ...
        next: mode === "reconstruction"
          ? "Read <skill-root>/references/element-review.md and "
            + "<skill-root>/references/reconstruction/comparison-round.md, then for each: "
          ...
          : "Read <skill-root>/references/element-review.md and "
            + "<skill-root>/references/original-authoring/conformance-round.md, then for each: "
            + "render the element as the Source configures it, mock the layers a Build has not made, "
