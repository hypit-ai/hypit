...
function usage(): string {
  return [
    ...
    "for the observer to judge centring, frame capacity and Canvas safety; it does not measure rendered",
    "glyph bounds or decide whether an overhang is intentional.",
    "",
