...
function usage(): string {
  return [
    ...
    "Canvas offsets, containment overflow and bound element ids. Use it as a mechanical geometry report",
    "for the observer to judge centring, frame capacity and Canvas safety; layout_geometry.overlaps adds",
    "advisory same-Canvas, simultaneous partial-intersection candidates (full containment is omitted).",
