...
import { createBytePlusProvider } from "./index.js";
export const hypitPackage = {
  format: "hypit.node-package@1" as const,
  hostFacets: [
    createRuntimeEndpointAdapterFacet({
      use: "@hypit/provider-byteplus",
      activate(context) {
        const c = runtimeConfigObject(context.config, "byteplus");
        runtimeConfigExact(
          c,
          [
            "apiKey",
        ...
        return {
          endpoint: createBytePlusProvider({
