...
export const canvasFrameFragment = sealGraphFragment({
  ...
  exports: [{ name: "frame", type: spatialTypes.frame, root: operation("resolve"), semanticInputs: ["canvas"], fidelity: "exact" }],
});
...
export const frameEdgesFragment = sealGraphFragment({
  ...
  exports: [{ name: "frame", type: spatialTypes.frame, root: operation("resolve"), semanticInputs: ["parent", "program"], fidelity: "exact" }],
});
...
export const aspectFrameFragment = sealGraphFragment({
  ...
  exports: [{ name: "frame", type: spatialTypes.frame, root: operation("resolve"), semanticInputs: ["parent", "extent", "program"], fidelity: "exact" }],
});
...
export const fitContentFragment = sealGraphFragment({
  ...
  exports: [{ name: "fitted", type: spatialTypes.fitted, root: operation("resolve"), semanticInputs: ["frame", "extent", "fit"], fidelity: "exact" }],
});
