...
async function smokeCases(root: string): Promise<readonly SmokeCase[]> {
  ...
  const cases: Array<Omit<SmokeCase, "ids">> = [
    {
      key: "gpt-image-2",
      media: "image",
      endpoint: endpoint(gptImageEndpoints.text, "GPT Image 2 text"),
      manifest: gptImageManifest,
      component: gptImageComponent,
      request: sealGptImage2Request({
        contract: "svml.gpt-image-2-request@1",
        model: "gpt-image-2",
        mode: "text",
    ...
    },
    {
      key: "seedream-5-lite",
      media: "image",
      endpoint: endpoint(seedreamEndpoints.text, "Seedream 5 Lite text"),
    ...
    },
    {
      key: "minimax-h3",
      media: "video",
      endpoint: endpoint(minimaxH3Endpoints.text, "MiniMax H3 text"),
      manifest: minimaxH3Manifest,
      component: minimaxH3Component,
      request: sealMinimaxH3Request({
        contract: "svml.minimax-h3-request@1",
        model: "minimax-h3",
        mode: "text",
        prompt: motionPrompt,
        durationSec: 6,
    ...
    },
    {
      key: "grok-imagine",
      media: "video",
      endpoint: endpoint(grokImagineEndpoints.text, "Grok Imagine text"),
      manifest: grokImagineManifest,
      component: grokImagineComponent,
      request: sealGrokImagineRequest({
        contract: "svml.grok-imagine-video-request@1",
  ...
  if (referencePath !== undefined) {
    ...
    cases.push({
      ...
      media: "image",
      endpoint: endpoint(gptImageEndpoints.image, "GPT Image 2 image"),
      manifest: gptImageManifest,
      component: gptImageComponent,
      request: sealGptImage2Request({
        contract: "svml.gpt-image-2-request@1",
