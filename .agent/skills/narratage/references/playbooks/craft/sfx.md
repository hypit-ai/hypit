...
- Add a sound only for a perceptible event: motion landing, UI state change, reveal, or transition.
  No event means no effect.
- One sound has one job. Do not stack impact, whoosh, click, and ambience on the same beat.
- Dialogue wins. Keep effects short/light enough not to mask consonants, numbers, names, or conclusions.
