...
- [`talking-head-aroll`](./talking-head-aroll/README.md) is the current four-take acceptance witness
  and demonstrates a second Run that explicitly reuses historical shot Records as zero-input
