...
The comparison loop arrives here in batches. One element is compared against every stretch it is drawn
over before any repair, and `reconstruction-loop.md` has the renders all made before the first
